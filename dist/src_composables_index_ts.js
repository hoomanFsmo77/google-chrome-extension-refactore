...
/* harmony export */ });
/* harmony import */ var _store_popular__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../store/popular */ "./src/store/popular.ts");
/* harmony import */ var _store_user__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/user */ "./src/store/user.ts");
...
var usePopularIndex = function usePopularIndex() {
  var popularStore = (0,_store_popular__WEBPACK_IMPORTED_MODULE_0__.usePopularCoinStore)();
...
var useUserIndex = function useUserIndex() {
  ...
  var favCoinList = (0,vue__WEBPACK_IMPORTED_MODULE_3__.computed)(function () {
    return userStore.getFavCoinList;
  });
  return {
  ...
  getters: {
    ...
    getFilteredCoinList: function getFilteredCoinList() {
      return function (allCoinList) {
        var result = [];
        _utils_Helper__WEBPACK_IMPORTED_MODULE_0__.favCoins.forEach(function (item) {
